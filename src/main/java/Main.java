...
public class Main
{
    ...
    {
        logger1 = LogManager.getLogger("SearchStation");
        logger2 = LogManager.getLogger("WarnStation");
        logger3 = LogManager.getLogger("ExceptionsFile");
        ...
        for(;;)
        {
            try {
                ...
                throw new StationExpection("Неправильный ввод станции.");
            } catch (Exception e) {
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            logger2.warn("Станция не найдена: " + line);
